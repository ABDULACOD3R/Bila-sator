...
\033[1;93m  
 ...
 .S_SSSs     .S  S.       .S_SSSs            sSSs   .S_SSSs    sdSS_SSSSSSbs    sSSs_sSSs     .S_sSSs    
.SS~SSSSS   .SS  SS.     .SS~SSSSS          d%%SP  .SS~SSSSS   YSSS~S%SSSSSP   d%%SP~YS%%b   .SS~YS%%b   
S%S   SSSS  S%S  S%S     S%S   SSSS        d%S'    S%S   SSSS       S%S       d%S'     `S%b  S%S   `S%b  
S%S    S%S  S%S  S%S     S%S    S%S        S%|     S%S    S%S       S%S       S%S       S%S  S%S    S%S  
S%S SSSS%P  S&S  S&S     S%S SSSS%S        S&S     S%S SSSS%S       S&S       S&S       S&S  S%S    d*S  
S&S  SSSY   S&S  S&S     S&S  SSS%S        Y&Ss    S&S  SSS%S       S&S       S&S       S&S  S&S   .S*S  
S&S    S&S  S&S  S&S     S&S    S&S        `S&&S   S&S    S&S       S&S       S&S       S&S  S&S_sdSSS   
S&S    S&S  S&S  S&S     S&S    S&S          `S*S  S&S    S&S       S&S       S&S       S&S  S&S~YSY%b   
S*S    S&S  S*S  S*b     S*S    S&S           l*S  S*S    S&S       S*S       S*b       d*S  S*S   `S%b  
S*S    S*S  S*S  S*S.    S*S    S*S          .S*P  S*S    S*S       S*S       S*S.     .S*S  S*S    S%S  
S*S SSSSP   S*S   SSSbs  S*S    S*S        sSS*S   S*S    S*S       S*S        SSSbs_sdSSS   S*S    S&S  
S*S  SSY    S*S    YSSP  SSS    S*S        YSS'    SSS    S*S       S*S         YSSP~YSSY    S*S    SSS  
SP          SP                  SP                        SP        SP                       SP          
Y           Y                   Y                         Y         Y                        Y           
                                                                                                         

"""
CorrectUsername = 'Bila'
CorrectPassword = 'sator'
os.system('clear')
print logo
loop = 'true'
while loop == 'true':
